...
const initialState = {
  ...
  customOrderSendToUAEData: [],
  isCustomOrderSendToUAE: false,
  error: null,
};
...
const OrderSystemChinaReducer = (state = initialState, action) => {
  switch (action.type) {
    ...
    case CUSTOM_ORDER_SEND_UAE_REQUEST:
      return { ...state, isCustomOrderSendToUAE: true };
    case CUSTOM_ORDER_SEND_UAE_SUCCESS:
      return {
        ...state,
        isCustomOrderSendToUAE: false,
        customOrderSendToUAEData: action.payload,
      };
    case CUSTOM_ORDER_SEND_UAE_FAIL:
      return {
        ...state,
        isCustomOrderSendToUAE: false,
        error: action.payload,
