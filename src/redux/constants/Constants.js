...
export const GET_COMPLETED_ORDER_SYSTEM_REQUEST = "GET_COMPLETED_ORDER_SYSTEM_REQUEST";
export const GET_COMPLETED_ORDER_SYSTEM_SUCCESS = "GET_COMPLETED_ORDER_SYSTEM_SUCCESS";
export const GET_COMPLETED_ORDER_SYSTEM_FAIL = "GET_COMPLETED_ORDER_SYSTEM_FAIL";

export const GET_COMPLETED_ORDER_DETAILS_SYSTEM_REQUEST = "GET_COMPLETED_ORDER_DETAILS_SYSTEM_REQUEST";
export const GET_COMPLETED_ORDER_DETAILS_SYSTEM_SUCCESS = "GET_COMPLETED_ORDER_DETAILS_SYSTEM_SUCCESS";
export const GET_COMPLETED_ORDER_DETAILS_SYSTEM_FAIL = "GET_COMPLETED_ORDER_DETAILS_SYSTEM_FAIL";
...
export const GET_MANUAL_OR_SCHEDULED_PO_DETAILS_REQUEST = "GET_MANUAL_OR_SCHEDULED_PO_DETAILS_REQUEST";
export const GET_MANUAL_OR_SCHEDULED_PO_DETAILS_SUCCESS = "GET_MANUAL_OR_SCHEDULED_PO_DETAILS_SUCCESS";
export const GET_MANUAL_OR_SCHEDULED_PO_DETAILS_FAIL = "GET_MANUAL_OR_SCHEDULED_PO_DETAILS_FAIL";
