...
export const GET_MANUAL_PO_DETAILS_REQUEST = "GET_MANUAL_PO_DETAILS_REQUEST";
export const GET_MANUAL_PO_DETAILS_SUCCESS = "GET_MANUAL_PO_DETAILS_SUCCESS";
export const GET_MANUAL_PO_DETAILS_FAIL = "GET_MANUAL_PO_DETAILS_FAIL";

export const GET_SCHEDULE_PO_DETAILS_REQUEST =
  "GET_SCHEDULE_PO_DETAILS_REQUEST";
export const GET_SCHEDULE_PO_DETAILS_SUCCESS =
  "GET_SCHEDULE_PO_DETAILS_SUCCESS";
export const GET_SCHEDULE_PO_DETAILS_FAIL = "GET_SCHEDULE_PO_DETAILS_FAIL";
...
export const GET_QUANTITY_DETAILS_REQUEST =
  "GET_QUANTITY_DETAILS_REQUEST";
export const GET_QUANTITY_DETAILS_SUCCESS =
