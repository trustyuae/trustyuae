...
export const UPDATE_ORDER_NOT_AVAILABLE_STATUS_REQUEST = "UPDATE_ORDER_NOT_AVAILABLE_STATUS_REQUEST";
export const UPDATE_ORDER_NOT_AVAILABLE_STATUS_SUCCESS = "UPDATE_ORDER_NOT_AVAILABLE_STATUS_SUCCESS";
export const UPDATE_ORDER_NOT_AVAILABLE_STATUS_FAIL = "UPDATE_ORDER_NOT_AVAILABLE_STATUS_FAIL";
...
export const GET_PRODUCT_ORDER_DETAILS_REQUEST = "GET_PRODUCT_ORDER_DETAILS_REQUEST";
export const GET_PRODUCT_ORDER_DETAILS_SUCCESS = "GET_PRODUCT_ORDER_DETAILS_SUCCESS";
export const GET_PRODUCT_ORDER_DETAILS_FAIL = "GET_PRODUCT_ORDER_DETAILS_FAIL";

export const ADD_PRODUCT_ORDER_FOR_PREP_REQUEST = "ADD_PRODUCT_ORDER_FOR_PREP_REQUEST";
export const ADD_PRODUCT_ORDER_FOR_PREP_SUCCESS = "ADD_PRODUCT_ORDER_FOR_PREP_SUCCESS";
export const ADD_PRODUCT_ORDER_FOR_PREP_FAIL = "ADD_PRODUCT_ORDER_FOR_PREP_FAIL";

export const ADD_PRODUCT_ORDER_FOR_STOCK_REQUEST = "ADD_PRODUCT_ORDER_FOR_STOCK_REQUEST";
export const ADD_PRODUCT_ORDER_FOR_STOCK_SUCCESS = "ADD_PRODUCT_ORDER_FOR_STOCK_SUCCESS";
export const ADD_PRODUCT_ORDER_FOR_STOCK_FAIL = "ADD_PRODUCT_ORDER_FOR_STOCK_FAIL";
