...
// import { OrderDetailsGet } from "../../redux/actions/OrderSystemActions";
...
//   const [selectedFile, setSelectedFile] = useState(null); // Change from selectFile to selectedFile
...
//         console.log(response.data.orders, "ressssssssssssssssssssssssssss");
//       } catch (error) {
...
//     (state) => state?.orderSystemData?.orderDetails
//   );
...
//   //   setSelectedFile(e.target.files[0]); // Change from setFile to setSelectedFile
//   //   // setFile({ ...selectFile, factoryImage: e.target.files[0] });
//   //   setTimeout(() => {
//   //     console.log(selectedFile, "selectedFile"); // Change from selectFile to selectedFile
//   //   }, 2000);
//   // };
...
//             </button>
//              {isStarted ? ( 
//               <Button variant="success" disabled>Started</Button>
//             ):( 
//               <Button variant="success" >Started</Button>
//             )}
//           </MDBCol>
//         </MDBRow>
//         <MDBRow>
...
//                   </td>
//                   <td className="text-center">
//                     {getCountryName(order.shipping_country)}
//                   </td>
//                 </tr>
//               ))}
//             </tbody>
...
//                     <td className="text-center">{product.variation_value}</td>
//                     <td className="text-center">
