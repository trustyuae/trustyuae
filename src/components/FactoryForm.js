...
function FactoryForm() {
    ...
    const handleSubmit = async (e) => {
        e.preventDefault();
        try {
            const response = await axios.post('https://ghostwhite-guanaco-836757.hostingersite.com/wp-json/custom-factory/v1/add-factory', factory);
            ...
            <Row className="justify-content-center mt-5">
                <Col md={6}>
                    <Card className="factory-card">
                        <Card.Header as="h5" className="factory-card-header">Add New Factory</Card.Header>
                        <Card.Body>
                            <Form onSubmit={handleSubmit}>
                                ...
                                <Form.Group className="mb-3" controlId="formFactoryContactPerson">
                                ...
                                <Form.Group className="mb-3" controlId="formFactoryContactNumber">
                                ...
                                <Form.Group className="mb-3" controlId="formFactoryContactEmail">
                                ...
                                <Form.Group className="mb-3" controlId="formFactoryBankAccountDetails">
